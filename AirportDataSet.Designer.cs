...
namespace AirLine {
    ...
    public partial class AirportDataSet : global::System.Data.DataSet {
        ...
        public partial class airportsDataTable : global::System.Data.TypedTableBase<airportsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public airportsRow AddairportsRow(string name, string alias) {
        ...
        public partial class airportsRow : global::System.Data.DataRow {
            ...
            public string alias {
                get {
                    try {
                        return ((string)(this[this.tableairports.aliasColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'alias\' in table \'airports\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableairports.aliasColumn] = value;
                }
            }
            ...
            public bool IsaliasNull() {
                return this.IsNull(this.tableairports.aliasColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetaliasNull() {
                this[this.tableairports.aliasColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace AirLine.AirportDataSetTableAdapters {
    ...
    public partial class airportsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[airports] ([name], [alias]) VALUES (@name, @alias);\r\nSELECT id" +
                ", name, alias FROM airports WHERE (id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@alias", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "alias", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[airports] SET [name] = @name, [alias] = @alias WHERE (([id] = @Orig" +
                "inal_id) AND ([name] = @Original_name));\r\nSELECT id, name, alias FROM airports W" +
                "HERE (id = @id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@alias", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "alias", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, alias FROM dbo.airports";
        ...
        public virtual int Update(string name, string alias, int Original_id, string Original_name, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string alias, int Original_id, string Original_name) {
            return this.Update(name, alias, Original_id, Original_name, Original_id);
        }
    }
